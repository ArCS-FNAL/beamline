...
export OUTDIR=/pnfs/lariat/persistent/users/$USER/BeamLineSimOutputs/pos60Amps/complete_sim/varying_fields/B0.50_new
export G4BNBINPUT=arcs_beamline_config09_variable50.in
...
cp -f ${PWD}/inputs/various_fields/field_multiplied_0.50.txt ${BOOKDIR}
...
-f ${BOOKDIR}/JGG.in \
-f ${BOOKDIR}/various_fields/field_multiplied_0.50.txt \
...
cp -f ${PWD}/inputs/various_fields/field_multiplied_0.50.txt ${OUTDIR}/config/
...
cp -f ${PWD}/Jobsubmit50.sh ${OUTDIR}/config/
