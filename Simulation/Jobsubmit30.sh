...
export OUTDIR=/pnfs/lariat/persistent/users/lunich/BeamLineSimOutputs/pos60Amps/complete_sim/varying_fields/B0.30
export G4BNBINPUT=arcs_beamline_config09_variable30.in
...
cp -f ${PWD}/inputs/various_fields/field_multiplied_0.30.txt ${BOOKDIR}
cp -f ${PWD}/inputs/field_halved_2.0.txt ${BOOKDIR}
cp -f -r  ${PWD}/inputs/various_fields ${BOOKDIR}
...
-f ${BOOKDIR}/various_fields/field_multiplied_0.30.txt \
...
cp -f ${PWD}/inputs/various_fields/field_multiplied_0.30.txt ${OUTDIR}/config/
