...
export OUTDIR=/pnfs/lariat/persistent/users/$USER/BeamLineSimOutputs/pos60Amps/complete_sim/varying_fields/B0.10
export G4BNBINPUT=arcs_beamline_config09_variable10.in
...
cp -f ${PWD}/inputs/various_fields/field_multiplied_0.10.txt ${BOOKDIR}
...
-f ${BOOKDIR}/JGG.in \
-f ${BOOKDIR}/various_fields/field_multiplied_0.10.txt \
...
cp -f ${PWD}/inputs/various_fields/field_multiplied_0.10.txt ${OUTDIR}/config/
