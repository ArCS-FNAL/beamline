...
export OUTDIR=/exp/lariat/data/users/lunich/sims_to_analyze
export G4BNBINPUT=arcs_beamline_config09_variable05.in
...
cp -f ${PWD}/inputs/various_fields/field_multiplied_0.05.txt ${BOOKDIR}
...
-f ${BOOKDIR}/JGG.in \
-f ${BOOKDIR}various_fields/field_multiplied_0.05.txt \
...
cp -f ${PWD}/inputs/various_fields/field_multiplied_0.05.txt ${OUTDIR}/config/
