...
export OUTDIR=/pnfs/lariat/persistent/users/$USER/BeamLineSimOutputs/pos60Amps/complete_sim/varying_fields/B0.20
export G4BNBINPUT=arcs_beamline_config09_variable20.in
...
cp -f ${PWD}/inputs/various_fields/field_multiplied_0.20.txt ${BOOKDIR}
...
-f ${BOOKDIR}/JGG.in \
-f ${BOOKDIR}/various_fields/field_multiplied_0.20.txt \
...
cp -f ${PWD}/inputs/various_fields/field_multiplied_0.20.txt ${OUTDIR}/config/
